...
class SectionTwo extends Component {
    ...
    render() {
        ...
        return(
            <SectionTwoMain className={active ? "lightbox-active" : ""}>
                <div
                class="section-grid"
                >
                    {data.wordpressWpCustomPage.acf.cv2_s2_gallery.map((imgSrc, i) => {
                        return(
                        <GalleryImage id={"GalleryS2Image_" + i} onClick={() => this.handleClick(i)}>
                    ...
                    <div class="main-lightbox">
                        ...
                        {data.wordpressWpCustomPage.acf.cv2_s2_gallery.map((imgSrc, i) => {
                            return(
                            <LightboxImage id={"LightboxS2Image_" + i} className= {i === this.state.activeImage ? "active-image" : "inactive-image"}>
                                <Img sizes={imgSrc.localFile.childImageSharp.sizes} alt={imgSrc.title} />
                            </LightboxImage>
                            )
                        })}
...
const SectionTwoMain = styled.section`
    padding-top: 0px;
    > div.section-grid {
        position: relative;
        display: grid;
...
export default props => (
    <StaticQuery
      ...
      `}
      render={data => <SectionTwo data={data} {...props} />}
    />
  );