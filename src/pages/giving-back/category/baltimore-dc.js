...
class Baltimore extends Component {
...
export default props => (
    <StaticQuery
      query={graphql`
        query {
            allWordpressWpCustomPage(filter: {categories: {elemMatch: {wordpress_id: {eq: 61}}}}) {
                edges {
                    node {
                        featured_media {
                            localFile {
            ...
            allWordpressWpGbBlogPost(filter: {categories: {elemMatch: {wordpress_id: {in: 61}}}}) {
                edges {
                    node {
                        title
                        slug
      ...
      `}
      render={data => <Baltimore data={data} {...props} />}
    />
  );