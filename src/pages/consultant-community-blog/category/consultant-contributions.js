...
const ConsultantContributionsPage = ({ data }) => (
    <CCLayout>
        ...
        <CCmain>
            <TitleSection>
                ...
                <hr/>
                <h1>Consultant Contributions</h1>
            </TitleSection>
            <CCrow>
...
export default ConsultantContributionsPage

export const query = graphql`
    query {
        allWordpressWpCcBlogPost(filter: {categories: {elemMatch: {wordpress_id: {eq: 52}}}}, sort: {fields: date, order: DESC}) {
            edges {
                node {
                title
                slug
