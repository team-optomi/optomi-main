...
export default ITTrendsNewsPage

export const query = graphql`
    query {
        allWordpressWpCcBlogPost(filter: {categories: {elemMatch: {wordpress_id: {eq: 54}}}}, sort: {fields: date, order: DESC}) {
            edges {
                node {
                title
                slug
