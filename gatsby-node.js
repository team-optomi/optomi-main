...
exports.createPages = async ({ graphql, actions, reporter }) => {
  ...
  createRedirect({ fromPath: '/connected/*', toPath: 'https://connected.optomi.com', isPermanent: true })
  createRedirect({ fromPath: '/connected/?connected=7ToTA58xab', toPath: 'https://connected.optomi.com/?connected=7ToTA58xab', isPermanent: true, force: true })
